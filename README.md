...
| Prefab 资产编辑 | 场景物体存成 Prefab 资产；改 Transform、删物体、内嵌子 Prefab；新建物体/几何体、加组件、写属性 | `prefab.create` `prefab.edit/remove/instantiate/create_object/create_primitive/add_component/set` |
