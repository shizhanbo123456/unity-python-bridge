...
| [`COMMANDS.md`](COMMANDS.md) | **用命令时** | 38 条命令的完整参考：服务端命令名、CLI 别名、全部参数、常用工作流 |
...
├── COMMANDS.md                     # 完整命令列表（38 条，含参数与示例）
